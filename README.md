...
This repository was developed alongside the paper [Vision Language Action Models in Robotic Manipulation: A Systematic Review](assets/manuscript.pdf) and provides a living catalog of:
